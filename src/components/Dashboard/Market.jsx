...
const Market = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-gradient-to-br from-gray-900 via-gray-900 to-slate-900 min-h-screen">
      ...
      <div className={`text-gray-200 sidebar fixed lg:relative w-80 bg-black/60 rounded-md lg:m-1 shadow-2xl border border-white/5 z-40 h-screen lg:h-auto transition-all duration-300 ${isSidebarOpen ? 'left-0' : '-left-80 lg:left-0'
        }`}>
